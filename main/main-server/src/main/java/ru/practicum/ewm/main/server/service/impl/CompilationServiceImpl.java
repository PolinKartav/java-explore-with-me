...
public class CompilationServiceImpl implements CompilationService {
        ...
        try {
            ...
            if (dto.getEvents() != null && !dto.getEvents().isEmpty()) {
                ...
                try {
                    ...
                    throw new AlreadyExistedException("События " + dto.getEvents() + " не существует");
                }
            } else {
            ...
            throw new AlreadyExistedException("Компиляция с событиями " + dto.getEvents() + " уже существует");
        }
    }
    ...
    private Compilation getCompilationById(Long compId) {
        return compilationRepository.findById(compId).orElseThrow(
                () -> new NotFoundException("Компиляция с id= " + compId + " не существует")
        );
    }
}
